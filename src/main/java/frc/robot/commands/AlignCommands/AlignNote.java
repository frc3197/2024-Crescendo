...
public class AlignNote extends Command {
  ...
  public AlignNote(Vision vision, Drive drive) {
    this.vision = vision;
    this.drive = drive;
  ...
  public void execute() {
    ...
    drive.drive(new Translation2d(-0.75, 0), -MathUtil.clamp(Vision.getBestTarget()[0]/12, -maxRotSpeed, maxRotSpeed), false, false);
  }
